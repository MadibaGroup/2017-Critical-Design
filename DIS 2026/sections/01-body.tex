...
\textcolor{blue}{(LEAH: PERHAPS THESE COULD  BE CONVERTED INTO DISCUSION POINTS, LIKE HOW WE EXPECT PEOPLE TO USE THE VIGNETTES, AND OUR THOUGHTS ON THE METHODOLOGY TO DEVELOP THEM?  I ADDED A BIT OF TEXT ABOUT VIGNETTE AND THEIR USE IN HCI AND USABLE PRIVACY AND SECURITY)}
...
Vignettes, defined as ``short stories about hypothetical characters in specified circumstances, to whose situation the interviewee is invited to respond'' ~\cite{finch1987vignette} are also established instruments  in speculative design, design fiction, and scenario-based inquiry in HCI. In these contexts, short narratives depictions of hypothetical technologies or practices are used to surface assumptions, explore value tensions, and prompt reflection on possible futures without requiring the artefact itself to exist materially. Design fiction work in HCI, in particular, are not treated as empirical stimuli for behavioural measurement, but as structured prompts that enable participants to reason about situated technological futures, their consequences, tradeoffs, and social norms. Vignette-based methods in usable security research (e.g., ~\cite{naeini2017privacy}, ~\cite{hadan2024privacy}) similarily construct narratives to investigate user expectations, decision-making processes, and ethical considerations surrounding emerging technologies when direct obervation or deployment is infeasive, unsafe, or premature.

In this work, we propose vignettes as a methodological vehicle for communicating speculative artefacts rather than as experimental instruments intended to elicit measurable responses. The vignettes function as analytic artefacts: they instantiate design concepts in situated contexts, articulate their purpose and functionality, and embed a short narrative through which readers can interpret and reflect on the security and privacy tensions being surfaced. This approach aligns with established HCI practices in which narrative scenarios are used to probe socio-technical implications. However, it does not aim to produce generalizable behavioural data or predictive claims about user action. Instead, our objective is interpretive and exploratory — to expose assumptions, provoke critical reasoning, and broaden discourse around the topics under investigation.

Beyond their role within this paper, these vignettes are intended to be shareable artefacts that others may appropriate for reflection, inquiry, and design exploration. While we invite open interpretation in their application, we anticipate several avenues of use. First, critical design vignettes may serve as reflective prompts in educational, participatory, or professional contexts, where speculative scenarios facilitate discussion of assumptions, values, and mental models surrounding security and privacy practices. Second, they may function as research instruments in future speculative design or vignette-based studies, where they can be adapted as stimuli to explore perceptions of risk, trust, or technological futures. Finally, we envision their use as generative tools in design processes — inspiring ideation, highlighting overlooked attack surfaces, or prompting reconsideration of design assumptions before technologies are implemented.

We therefore position the vignette as an appropriate methodological form for a Provocations contribution: a lightweight, imaginable, and scalable medium that enables speculative artefacts to be encountered without technological implementation while remaining grounded in established HCI traditions, including the use of vignettes in survey research, design fiction, and scenario-based studies. By embedding each design within a relatable narrative situation, the vignettes activate readers’ existing mental models and experiential knowledge, supporting reflective engagement with security and privacy risks that are otherwise difficult to visualize or experience directly.
