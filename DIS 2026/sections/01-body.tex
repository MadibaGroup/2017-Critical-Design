...
In this Provocations paper, we presented the initial ideas for creating critical design vignettes for privacy and security concepts. Building on our reflections, we will explore a more systematic approach to the design creation process. We plan to first investigate an initial step in our methodology for brainstorming ideas for the designs using ideation cards. We will try different design methodologies from the literature (like exploring convergent and divergent methods, mapping and prototyping), and establish a reproducible methodology. Drawing on our initial experiments with generating designs, we aim to address the difficulties we encountered during this process (\ie coming up with topics related to security and privacy, attaining a level of plausibility etc.). By choosing the most relevant method from user research, we will also evaluate the effectiveness of our future methodology. We will also discuss whether our methodology can be applied to other areas in computer science like AI, robotics etc.
