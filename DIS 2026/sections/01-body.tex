...
(LEAH: MAYBE WE CAN OPEN WITH ONE OF OUR VIGNETTES AS A HOOK LIKE THIS? I ALSO ADDED A BIT MORE CONTEXT FOR THE INTRO)
...
(LEAH: PERHAPS THESE COULD  BE CONVERTED INTO DISCUSION POINTS, LIKE HOW WE EXPECT PEOPLE TO USE THE VIGNETTES, AND OUR THOUGHTS ON THE METHODOLOGY TO DEVELOP THEM?  I ADDED A BIT OF TEXT ABOUT VIGNETTE AND THEIR USE IN HCI AND USABLE PRIVACY AND SECURITY)
...
Vignettes, defined as ``short stories about hypothetical characters in specified circumstances, to whose situation the interviewee is invited to respond'' (CITE Finch 1987), are also established instruments  in speculative design, design fiction, and scenario-based inquiry in HCI. In these contexs, short narratives depictions of hypothetical technologies or practices are used to surface assumptions, explore value tensions, and prompt reflection on possible futures without requiring the artefact itself to exist materially. Design fiction work in HCI, in particular, are not treated as empirical stimuli for behavioural measurement, but as structured prompts that enable participants to reason about situated technological futures, their consequences, tradeoffs, and social norms. Vignette-based methods in usable security research (e.g., CITE Naeini et al., 2017; Hadan et al. 2024) similarily construct narratives to investigate user expectations, decision-making processes, and ethical considerations surrounding emerging technologies when direct obervation or deployment is infeasive, unsafe, or premature.
