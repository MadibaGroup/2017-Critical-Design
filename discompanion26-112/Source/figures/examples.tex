...
\centering
\small
\caption{Examples of Critical Design Vignettes\label{tab:examples}}
\Description{A two-column table listing three critical design artefacts and their vignette descriptions: Compass Table, which makes electromagnetic activity visible through reactive compasses; Life Counter, which counts down a user’s remaining lifespan; and Open Informant, which displays fragments of personal communications to expose surveillance and privacy concerns.}

\begin{tabular}{|p{3cm}|p{13cm}|} 
\hline

\textbf{Work} & \textbf{Vignette} \\ \hline


\textit{Compass Table}, \newline A. Dunne and F. Raby &
