...
%Together, these critical designs enable reflection on issues such as the portability of biometric identity, ambient surveillance, and the unintended consequences of personalization, demonstrating the breadth of concerns that can be explored through critical design in security and privacy contexts. 
%This corpus serves as a proof-of-concept for our future work on developing a more structured approach to generating critical design probes for security and privacy.
