...
\newcommand{\designsmall}[2]{\noindent \begin{center} \begin{tabular}{|p{0.95\columnwidth}|}\hline\textbf{#1.} #2  \\ \hline \end{tabular} \end{center}}
\newcommand{\design}[2]{\noindent \begin{center} \begin{tabular}{|p{0.95\textwidth}|}\hline\textbf{#1.} #2  \\ \hline \end{tabular} \end{center}}

\newcommand{\gpt}{\texttt{ChatGPT}\xspace}
\newcommand{\gptv}{version \texttt{GPT-4g}\xspace}

%\renewcommand{\design}[2]{\textbf{#1.} #2 \\ \hline}
