...
There aren't any work at the intersection of privacy and critical design. But there are works on finding alternative ways to explain security concepts: Design fiction~\cite{loureiro-koechlin_vision_2022}, role playing game~\cite{merrill_security_2020}, 

other fields like sensing technologies: science fiction and design fiction~\cite{wong_real-fictional_2017}

\paragraph{\textbf{Critical desing+other fields}}
Using AI in creative writing: \cite{chakrabarty_art_2024}, \cite{kim_authors_2024}, fashion~\cite{davis_fashioning_2024}

\paragraph{\textbf{Methodological}} come up with the design manually like whiteboarding, sticky notes. 
...
\paragraph{\textbf{Evaluations:} }we only created the designs, 
...
\paragraph{\textbf{Teaching}}different methods to teach concepts related to computer science in general or cybersecurity to a diverse audience. How CS students perceive AI and Cybersecurity~\cite{ojha_computing_2023}, visual cryptography for K-12 students~\cite{rayavaram_designing_2023}
